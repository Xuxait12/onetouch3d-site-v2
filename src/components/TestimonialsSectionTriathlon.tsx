...
// Testimonials data for Triathlon page
const testimonialsTriathlon = [
  {
    quote:
...
function AnimatedTestimonialsTriathlonDemo() {
  return <AnimatedTestimonials testimonials={testimonialsTriathlon} />;
}

export function ComponentTriathlon() {
  return (
    <div className="relative flex w-full items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 py-4 md:py-8">
        ...
        <div className="z-10">
            <AnimatedTestimonialsTriathlonDemo />
        </div>
    </div>
  );
}

const TestimonialsSectionTriathlon = () => {
  return (
...
export default TestimonialsSectionTriathlon;

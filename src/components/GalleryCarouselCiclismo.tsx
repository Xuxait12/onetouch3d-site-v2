// TODO: Substituir imagens por fotos específicas de ciclismo
import { useState, useEffect } from "react";
import { Dialog, DialogContent } from "@/components/ui/dialog";
import { X, ChevronLeft, ChevronRight } from "lucide-react";

const GalleryCarouselCiclismo = () => {
  ...
  useEffect(() => {
    ...
    const galleryElement = document.getElementById('gallery-section-ciclismo');
    if (galleryElement) {

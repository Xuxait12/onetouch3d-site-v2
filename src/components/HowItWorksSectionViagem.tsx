...
// TODO: Atualizar passos para contexto de viagem
const steps = [{
  icon: MousePointer2,
  title: "Escolha seu modelo",
  description: "Selecione a moldura que mais combina com suas memórias de viagem."
}, {
  icon: Upload,
  title: "Envie suas informações",
  description: "Fotos, datas e informações da viagem tudo pelo Whatsapp."
}, {
  icon: CheckCircle,
...
export default HowItWorksSectionViagem;

...
const GallerySectionCorrida = () => {
  return <section className="py-8 md:py-12">
      <div className="text-center mb-16 animate-fade-up max-w-7xl py-0 mx-0 px-0 my-0">
        ...
        <p className="body-large text-muted-foreground text-center py-0 my-px">Inspire-se e transforme sua corrida em arte também.​
Deixe suas próprias vitórias ganharem vida em um quadro feito só para você.<br /><br />

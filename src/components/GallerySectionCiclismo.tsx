  ...
  return (
    <section className="py-8 md:py-12">
      <div className="text-center mb-16 animate-fade-up max-w-7xl mx-auto px-6">
        ...
        <p className="body-large text-muted-foreground">Veja como outros ciclistas transformaram suas medalhas em quadros únicos. Inspire-se e personalize o seu também!</p>

...
const heroVideo = "/videos/bike.mp4";
...
const HeroSectionCiclismo = () => {
  ...
  return <section id="hero-ciclismo" className="relative w-full min-h-[100svh] overflow-hidden bg-gray-900">
      {/* Background Video */}
      <video
        src={heroVideo}
        autoPlay
      ...
      <div className="relative z-10 h-full min-h-[100svh] flex items-end sm:items-center justify-center px-4 sm:px-6 pb-16 sm:pb-0">
        <div className="text-center text-white max-w-5xl mx-auto my-[53px]">
          ...
          {/* P com fade-up */}
          <motion.p initial={shouldReduceMotion ? {
          opacity: 1,
          y: 0
        } : {
          opacity: 0,
          ...
          ease: "easeOut"
            ...
            <motion.a href="#nossa-loja-ciclismo" aria-label="Personalize seu quadro agora" whileHover={shouldReduceMotion ? {} : {
            scale: 1.03
...
export default HeroSectionCiclismo;
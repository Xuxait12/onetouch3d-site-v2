...
const HeroSectionViagem = () => {
  ...
  const title = "Eternize Sua Viagem com um Quadro Personalizado";
  ...
  return <section id="hero-viagem" className="relative w-full min-h-[100svh] overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 h-full min-h-[100svh] flex items-end sm:items-center justify-center px-4 sm:px-6 pb-16 sm:pb-0 my-[53px]">
        <div className="text-center text-white max-w-5xl mx-auto">
          ...
          duration: 0.6,
          ease: "easeOut"
        }}>Personalize com percurso 3D, fotos e dados da sua aventura 
para criar uma lembrança inesquecível.</motion.p>
          ...
          <motion.p className="text-lg font-bold text-white/90 mt-4 mb-2 text-center drop-shadow-lg" initial={shouldReduceMotion ? { opacity: 1, y: 0 } : { opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={shouldReduceMotion ? {} : { delay: 0.85, duration: 0.5, ease: "easeOut" }}>
            🏷️ A partir de R$ 382,50 · Parcele em até 12x
          </motion.p>

...
// TODO: Substituir pela imagem hero específica de viagem
const heroImage = "/images/viagem-hero.webp";
...
const HeroSectionViagem = () => {
  const shouldReduceMotion = useReducedMotion();

  // TODO: Atualizar título para contexto de viagem
  const title = "Eternize Suas Viagens com um Quadro Personalizado";
    ...
    <section className="relative w-full h-[100vh] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6">
        <div className="text-center text-white max-w-5xl mx-auto">
          ...
          >
            {/* TODO: Atualizar descrição para contexto de viagem */}
            Preserve as memórias das suas viagens! Personalize com fotos e dados especiais para criar uma lembrança inesquecível.
          </motion.p>
...
export default HeroSectionViagem;

        ...
        <div className="max-w-2xl mx-auto">
          ...
          >
            ...
            <p className="text-muted-foreground text-base md:text-lg mb-8 max-w-lg mx-auto text-center">
              Compartilhe o site com um parceiro de pedal.<br />
              Cada gesto ajuda a transformar quilômetros em conquistas.
            </p>
...
export default ShareSectionCiclismo;

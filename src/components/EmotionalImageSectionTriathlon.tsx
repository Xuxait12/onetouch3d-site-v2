const EmotionalImageSectionTriathlon = () => {
  return (
    <section className="relative w-full h-[60vh] sm:h-[70vh] md:h-[80vh] overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img
          src="/images/emotional-triathlon.webp"
          alt="Quadro personalizado de triathlon Ironman em ambiente moderno"
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 md:p-12 lg:p-16">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col items-end text-right">
            ...
            >
              É a prova de que você foi até o limite.
            </p>
          </div>
        </div>
      </div>
...
export default EmotionalImageSectionTriathlon;

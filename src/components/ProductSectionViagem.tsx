...
// TODO: Duplicado de /corrida em [data] — revisar textos, imagens e preços para modalidade viagem
const ProductSectionViagem = () => {
  ...
  return (
    <section id="nossa-loja-viagem" data-section="nossa-loja-viagem" className="pt-2 md:pt-16 pb-16 bg-background product-section">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <p className="text-blue-600 font-medium">
                Quadro Personalizado de Viagem
              </p>
            </div>

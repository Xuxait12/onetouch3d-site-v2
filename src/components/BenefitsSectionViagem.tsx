...
// TODO: Atualizar benefícios para contexto de viagem
const benefits = [
  {
    icon: Award,
    title: "Destaque para suas memórias",
    description: "Suas viagens em evidência"
  },
  {
    icon: Palette,
  ...
  },
  {
    ...
    description: "Impressão de alta qualidade"
  },
  {
    icon: Truck,
...
export default BenefitsSectionViagem;

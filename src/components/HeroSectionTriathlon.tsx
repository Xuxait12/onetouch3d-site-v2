...
const heroTriathlon = "/images/triathlon-hero-2.webp";
...
const HeroSectionTriathlon = () => {
  const shouldReduceMotion = useReducedMotion();
  const title = "Eternize Seu Triathlon com um Quadro Personalizado";
  ...
  return <section id="hero-triathlon" className="relative w-full min-h-[100svh] overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0 bg-cover bg-no-repeat" style={{
      backgroundImage: `url(${heroTriathlon})`,
      ...
      <div className="relative z-10 h-full min-h-[100svh] flex items-end sm:items-center justify-center px-4 sm:px-6 pb-16 sm:pb-0">
        <div className="text-center text-white max-w-5xl mx-auto my-[53px]">
          ...
          ease: "easeOut"
            ...
            Sua medalha em destaque! Personalize seu quadro com miniaturas 3D dos percursos, fotos e dados da sua prova para criar uma lembrança inesquecível.
          </motion.p>
...
export default HeroSectionTriathlon;
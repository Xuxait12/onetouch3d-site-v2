...
const HeroSectionTriathlon = () => {
  ...
  return (
    <section id="hero-triathlon" className="relative w-full h-[100vh] overflow-hidden">
      {/* Background Image */}
      <div 
      ...
      <div className="relative z-10 h-full flex items-center justify-center px-4 sm:px-6">
        <div className="text-center text-white max-w-5xl mx-auto">
          ...
          >
            Deixe sua medalha em destaque! Personalize com percurso 3D, fotos e dados da sua prova para criar uma lembrança inesquecível.
          </motion.p>

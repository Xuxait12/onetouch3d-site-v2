      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="animate-fade-up">
          <Accordion type="single" collapsible className="w-full space-y-4">
            {faqData.map((faq, index) => <AccordionItem key={index} value={`item-ciclismo-${index}`} className="border border-border/20 rounded-lg px-6 bg-card/50 backdrop-blur-sm">
...
export default FAQSectionCiclismo;
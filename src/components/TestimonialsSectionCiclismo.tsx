...
// Testimonials data specific for Ciclismo page
const testimonialsCiclismo = [
  ...
  {
    quote:
      "Extremamente satisfeito do início ao fim, desde o atendimento até a chegada do produto, que é de fino acabamento!!",
    name: "Leony Espiga",
    designation: "Paris Brest Paris",
    src: "/lovable-uploads/leony-espiga-paris-brest-paris.webp",
  },
];
...
// Demo Component
function AnimatedTestimonialsCiclismoDemo() {
  return <AnimatedTestimonials testimonials={testimonialsCiclismo} />;
}

// Main Component
export function ComponentCiclismo() {
  return (
    <div className="relative flex w-full items-center justify-center overflow-hidden bg-slate-50 dark:bg-slate-950 py-4 md:py-8">
        ...
        <div className="z-10">
            <AnimatedTestimonialsCiclismoDemo />
        </div>
    </div>
  );
}

const TestimonialsSectionCiclismo = () => {
  return (
...
export default TestimonialsSectionCiclismo;

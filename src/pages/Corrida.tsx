    ...
    <div className="min-h-screen bg-transparent">
      ...
      <main>
        ...
        <FeatureSection
          ...
          description={<>Nossas molduras são produzidas com materiais de alta resistência e acabamento sofisticado.<br />Seu quadro não apenas valoriza sua medalha, mas também se torna parte da decoração.</>}

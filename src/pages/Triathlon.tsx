      ...
      <main>
        ...
        <div className="relative overflow-hidden">
          ...
          zIndex: 5
            ...
            <FeatureSection title="Elegância e Durabilidade" description={<>Acabamento à altura da sua conquista.<br /><br />Molduras resistentes, sofisticadas e com padrão profissional.<br /><br />Seu quadro não apenas valoriza sua medalha, mas se torna uma peça de destaque na decoração, com durabilidade e presença.</>} imageSrc="/images/quadro-moderno.gif" imageAlt="Moldura premium personalizada" imageOnLeft={false} mobileImageSrc="/images/moldura-caixa-alta-mobile.webp" />

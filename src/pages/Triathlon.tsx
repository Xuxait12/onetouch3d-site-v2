        ...
        <div className="relative overflow-hidden">
          ...
          <div className="relative" style={{ zIndex: 5 }}>
            ...
            <FeatureSection
              ...
              description={<>A emoção da prova em um lugar especial. Aquele registro na transição, o sorriso na corrida, o esforço na bike, o mergulho inicial.<br /><br />Suas fotos ganham um espaço pensado para transmitir a intensidade e o orgulho desse dia inesquecível.</>}

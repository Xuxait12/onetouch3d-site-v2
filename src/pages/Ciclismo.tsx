...
const Ciclismo = () => {
  ...
  return <div className="min-h-screen bg-transparent">
      ...
      <main>
        ...
        <FeatureSection title="Design Moderno e Exclusivo" description={<>O resultado é uma peça elegante, versátil e marcante.<br /><br />Integrando perfeitamente a qualquer ambiente — do escritório ao espaço esportivo da casa — transformando sua dedicação em arte e sua prova em decoração com propósito.</>} imageSrc="/images/bikepacking-ciclismo.webp" imageAlt="Ciclista em bikepacking nas montanhas" imageOnLeft={true} />

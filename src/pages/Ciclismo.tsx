      ...
      <main>
        ...
        <div className="relative overflow-hidden">
          ...
          zIndex: 5
            ...
            <FeatureSection title="Dados do Seu Pedal/Prova Personalizados" description={<>Personalizamos seu quadro com todas as informações que tornam sua conquista única — seu nome, sua prova, seu tempo oficial, sua velocidade média, e cada dado que representa o seu esforço real.<br /><br />O resultado é um registro autêntico, completo e emocionante da sua performance, transformando números em memória, esforço em arte e a sua conquista em algo digno de ser celebrado todos os dias.</>} imageSrc="/images/dados-pedal-ciclismo.webp" imageAlt="Dados da prova" imageOnLeft={false} />
